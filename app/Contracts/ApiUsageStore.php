 ...
 *
 * Counters are grouped per bucket into four flat string-keyed maps:
...
interface ApiUsageStore
{
     ...
     *
     * @return array{requests: array<string, int>, latency: array<string, int>, histogram: array<string, int>, clients: array<string, int>}
     */
