...
try
{
    ...
    checks.AddRange(CheckRegistry.RunAll(new CheckContext(options.ExtractDir, scan.FileTree, options.ArchiveSize, options.ModVersion, options.ModGuid, options.SptGeneration)));
