...
describe('Version Parsing', function (): void {
    it('can parse semantic versions correctly', function (): void {
        $versions = [
...
describe('SPT Version Import', function (): void {
    it('can clean imported SPT versions properly', function (): void {
        $versions = [
            'SPT 1.2.3' => '1.2.3',
    ...
    it('can guess semantic constraints from SPT version strings', function (): void {
        $versions = [
            'SPT 3.11' => '~3.11.0',
            'SPT 3.10' => '~3.10.0',
            'SPT 3.9' => '~3.9.0',
...
describe('Mod Version Import', function (): void {
    it('can parse imported mod versions after cleaning', function (): void {
        $versions = [
            '1' => '1.0.0',
            '1.2' => '1.2.0',
