...
describe('banned user redirects', function (): void {
...
describe('banned page expiry information', function (): void {
...
describe('moderator and admin ban visibility', function (): void {
...
describe('non-banned user access', function (): void {
