...
it('filters between two updated_at dates', function (): void {
    $v1 = SptVersion::factory()->create(['updated_at' => '2021-01-01 00:00:00']);
    $v2 = SptVersion::factory()->create(['updated_at' => '2021-01-02 00:00:00']);
    $v3 = SptVersion::factory()->create(['updated_at' => '2021-01-03 00:00:00']);
    $v4 = SptVersion::factory()->create(['updated_at' => '2021-01-04 00:00:00']);
    $v5 = SptVersion::factory()->create(['updated_at' => '2021-01-05 00:00:00']);
    $v6 = SptVersion::factory()->create(['updated_at' => '2021-01-06 00:00:00']);
