...
new #[Layout('layouts::base')] class extends Component
{
    ...
    public function mount(Mod $mod, ModVersion $modVersion): void
    {
        ...
        $this->virusTotalLinks = $modVersion->virusTotalLinks
            ->map(
        ...
        if ($modVersion->published_at) {
            $publishedAtLocal = Date::parse($modVersion->published_at)
    ...
    public function save(): void
    {
        ...
        Flux::toast(heading: 'Version Updated', text: 'Mod version has been successfully updated.', variant: 'success');

        $this->redirect($this->modVersion->mod->detail_url, navigate: true);
    }
    ...
    {
        $this->pinToSptVersions = $this->modVersion->sptVersions()->wherePivot('pinned_to_spt_publish', true)->exists();
    }
