...
new #[Layout('layouts::base')] class extends Component
{
    ...
    protected function rules(): array
    {
        ...
        // Cap the link at the mod_versions.link column size (varchar 255). Without this an over-long URL (e.g. a
        // signed release-asset link) passes validation and then fails at insert with a 500. bail short-circuits the
        // remaining rules, including the network HEAD check, once a cheaper rule fails.
