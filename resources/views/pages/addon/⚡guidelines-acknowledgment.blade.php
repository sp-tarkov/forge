...
<x-slot:description>
    {!! __('Please review and acknowledge the content guidelines before creating a new addon.') !!}
</x-slot>

<x-slot:header>
    <h2 class="font-semibold text-xl text-gray-900 dark:text-gray-200 leading-tight">
        {{ __('Before You Create an Addon') }}
    </h2>
</x-slot>
            ...
            <div class="p-6 sm:p-10">
                <div class="text-center mb-8">
                    ...
                    <p class="text-lg text-gray-600 dark:text-gray-400">Please review these key points before submitting
                        your addon for <strong>{{ $mod->name }}</strong></p>
                </div>
                ...
                <div class="space-y-6 mb-8">
                    ...
                    <div class="border-l-4 border-red-500 bg-red-50 dark:bg-red-900/20 p-5 rounded-r-lg">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 flex-1">
                                <h3 class="text-lg font-semibold text-red-800 dark:text-red-300">No AI-Generated Addons
                                </h3>
                                <p class="mt-1 text-sm text-red-700 dark:text-red-400">
                                    <strong>We do not accept addons that have been substantially or entirely written by
                                        AI.</strong> This includes addons where you've taken an existing addon, fed it
                                    to AI
                    ...
                    <div class="border-l-4 border-green-500 bg-green-50 dark:bg-green-900/20 p-5 rounded-r-lg">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 flex-1">
                                <h3 class="text-lg font-semibold text-green-800 dark:text-green-300">Test Your Addon
                                    Thoroughly</h3>
                                <p class="mt-1 text-sm text-green-700 dark:text-green-400">
                                    Test your addon on a fresh SPT installation with all documented dependencies and the
                                    required mod version. All advertised features must work as described without causing
                                    errors or unintended changes.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 flex-1">
                                ...
                                <p class="mt-1 text-sm text-purple-700 dark:text-purple-400">
                                    All addons must use semantic versioning (MAJOR.MINOR.PATCH) such as 1.2.3. Version
                                    numbers must be consistent across all addon files and match your code declarations.
                                </p>
                            </div>
                        </div>
                    </div>
