                        ...
                        <div class="grid grid-cols-6 gap-8">
                            ...
                            <flux:field class="col-span-6">
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                    ...
                                    @endif
                                    <flux:file-upload wire:model="thumbnail" @class(['h-full', 'lg:col-span-2' => !$thumbnail && !$mod->thumbnail])>
                            ...
                            <flux:field class="col-span-6">
                                <flux:checkbox.group label="AI Disclosure">
                                    @if ($this->aiContentLockedForUser)
                                        <div class="flex items-start gap-2">
                                            ...
                                            <flux:tooltip content="This setting is locked and may not be changed.">
                                                <flux:icon.lock-closed class="size-4 mt-0.5 text-zinc-500 dark:text-zinc-400" />
                                            </flux:tooltip>
                                        </div>
                                    @elseif ($this->canLockAiContent)
                                        ...
                                        >
                                            ...
                                            />
                                            <div class="flex items-start gap-2">
                                                <flux:icon.arrow-turn-down-right class="size-4 mt-1 text-zinc-400 dark:text-zinc-500" />
                                                <div class="flex-1">
                                ...
                                <flux:field
                                    class="mt-4"
                                    x-data="{ count: $wire.customAiDisclosure.length, text: $wire.customAiDisclosure }"
                                >
                                    <flux:label badge="Optional">{{ __('Custom Disclosure Message') }}</flux:label>
                                    <flux:description>
                                        {{ __('Optionally describe how AI was used in this project. This message will appear on the mod page when users expand the AI disclosure.') }}
                                    </flux:description>
                                    <flux:textarea
                                        wire:model.blur="customAiDisclosure"
                                        maxlength="1000"
                                        rows="4"
                                    ...
                                    <div
                                        class="mt-1 text-sm text-gray-500 dark:text-gray-400"
                                        x-text="`Max Length: ${count}/1000`"
                                    ></div>
                                    <flux:error name="customAiDisclosure" />
                                </flux:field>
                            </flux:field>
