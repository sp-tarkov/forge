        ...
        <div class="bg-gray-900 shadow-sm sm:rounded-lg overflow-hidden">
            <div class="p-6 sm:p-10">
                <div class="text-center mb-8">
                    ...
                    <h1 class="text-3xl font-bold text-gray-100 mb-2">Choose the Right Path</h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="border-l-4 border-green-500 bg-green-900/20 p-5 rounded-r-lg">
                        <div class="flex items-center mb-3">
                            <flux:icon.check-circle class="size-6 text-green-400 flex-shrink-0" />
                        ...
                        <ul class="space-y-2 text-sm text-green-400">
                            <li class="flex items-start">
                                <flux:icon.check
                                    class="size-4 mt-0.5 mr-2 text-green-400 flex-shrink-0" />
                                <span>You compile and ship a <code
                                        class="font-mono text-xs bg-green-900/40 px-1 rounded">.dll</code>
                                </span>
                            </li>
                            <li class="flex items-start">
                                <flux:icon.check
                    ...
                    <div class="border-l-4 border-red-500 bg-red-900/20 p-5 rounded-r-lg">
                        <div class="flex items-center mb-3">
                            <flux:icon.x-circle class="size-6 text-red-400 flex-shrink-0" />
                        ...
                        <ul class="space-y-2 text-sm text-red-400">
                            <li class="flex items-start">
                                <flux:icon.x-mark
                                    class="size-4 mt-0.5 mr-2 text-red-400 flex-shrink-0" />
                ...
                <div class="bg-gray-800 p-5 rounded-lg mb-8">
                    <div class="flex items-start">
                        <flux:icon.information-circle
                            class="size-6 text-cyan-400 flex-shrink-0 mt-0.5" />
                ...
                <div class="flex flex-col gap-4 max-w-md mx-auto">
                    ...
                    <flux:button
                        href="{{ route('mods') }}"
                        variant="primary"
                        class="w-full bg-red-700 hover:bg-red-600 text-white"
                    >
