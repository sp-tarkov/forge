    ...
    <x-slot name="header">
        <div class="flex items-center justify-between gap-3 w-full">
            <div class="flex items-center gap-2 sm:gap-3 min-w-0">
                ...
                />
                <h2
                    class="font-semibold text-lg sm:text-xl text-gray-100 leading-tight whitespace-nowrap">
                    {{ __('The Forge API') }}
                </h2>
                <flux:badge
                    icon="lock-open"
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div
            ...
            <div class="px-4 py-8 sm:px-6 lg:px-8">
                ...
                {{-- Hero Section --}}
                <div
                    class="relative overflow-hidden bg-gradient-to-br from-gray-900 via-black to-gray-950 ring-1 ring-white/10 rounded-2xl shadow-2xl mb-12">
                    {{-- Decorative accent glows --}}
                    <div
                        class="pointer-events-none absolute -top-24 left-1/4 size-80 -translate-x-1/2 rounded-full blur-3xl bg-cyan-500/25"
                    ></div>
                    <div
                        class="pointer-events-none absolute -bottom-24 right-1/4 size-80 translate-x-1/2 rounded-full blur-3xl bg-indigo-500/25"
                    ></div>
                    {{-- Dot grid texture --}}
                    <div
                    ...
                    <div class="relative px-6 py-8 sm:px-8 sm:py-10">
                        <div class="mx-auto max-w-4xl text-center">
                            ...
                            {{-- At-a-glance pills --}}
                            <div
                                class="flex flex-wrap justify-center gap-3 text-sm font-medium text-gray-300 mb-6">
                                <span
                                    class="inline-flex items-center gap-1.5 rounded-full bg-gray-800 ring-1 ring-white/10 px-3 py-1.5">
                            ...
                            <div class="mx-auto max-w-2xl text-left">
                                ...
                                <div
                                    class="flex items-center gap-2 rounded-xl bg-black ring-1 ring-white/10 px-4 py-3 font-mono text-sm text-cyan-300 overflow-x-auto">
  ...
  "meta": { "current_page": 1, "per_page": 1, "total": 842 }
                ...
                <div class="mb-12">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div
                            class="rounded-2xl bg-gradient-to-br from-gray-900 to-gray-950/60 ring-1 ring-white/10 p-6 shadow-sm transition duration-300 hover:shadow-md hover:ring-cyan-500/30">
                            <flux:icon
                                name="squares-2x2"
                                class="size-10 rounded-xl bg-cyan-500/10 p-2.5 text-cyan-400 mb-4 ring-1 ring-cyan-500/20"
                            />
                            <h3 class="font-semibold text-gray-100 mb-2">Mod managers &amp; browsers</h3>
                        ...
                        <div
                            ...
                            <flux:icon
                                ...
                                class="size-10 rounded-xl bg-cyan-500/10 p-2.5 text-cyan-400 mb-4 ring-1 ring-cyan-500/20"
                            />
                            <h3 class="font-semibold text-gray-100 mb-2">Update checkers</h3>
                            <p class="text-sm text-gray-400">
                        ...
                        <div
                            ...
                            <flux:icon
                                ...
                                class="size-10 rounded-xl bg-cyan-500/10 p-2.5 text-cyan-400 mb-4 ring-1 ring-cyan-500/20"
                            />
                            <h3 class="font-semibold text-gray-100 mb-2">Dependency resolvers</h3>
                            <p class="text-sm text-gray-400">
                        ...
                        <div
                            ...
                            <flux:icon
                                ...
                                class="size-10 rounded-xl bg-cyan-500/10 p-2.5 text-cyan-400 mb-4 ring-1 ring-cyan-500/20"
                            />
                            <h3 class="font-semibold text-gray-100 mb-2">Compatibility tooling</h3>
                            <p class="text-sm text-gray-400">
                        ...
                        <div
                            ...
                            <flux:icon
                                ...
                                class="size-10 rounded-xl bg-cyan-500/10 p-2.5 text-cyan-400 mb-4 ring-1 ring-cyan-500/20"
                            />
                            <h3 class="font-semibold text-gray-100 mb-2">Bots &amp; dashboards</h3>
                            <p class="text-sm text-gray-400">
                        ...
                        <div
                            ...
                            <flux:icon
                                ...
                                class="size-10 rounded-xl bg-cyan-500/10 p-2.5 text-cyan-400 mb-4 ring-1 ring-cyan-500/20"
                            />
                            <h3 class="font-semibold text-gray-100 mb-2">Whatever you dream up</h3>
                            <p class="text-sm text-gray-400">
                ...
                <div class="mb-12">
                    ...
                    <div
                        class="overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 to-gray-950/60 ring-1 ring-white/10 shadow-sm divide-y divide-white/10">
                        {{-- Mods --}}
                        <div>
                            <div
                                class="flex flex-wrap items-center gap-x-3 gap-y-1 bg-white/5 px-5 py-3">
                                <flux:icon.cube
                            ...
                            <div class="divide-y divide-white/5">
                                <div class="flex items-center gap-3 px-5 py-2.5">
                                    <span
                                        class="inline-flex w-12 shrink-0 justify-center rounded bg-emerald-500/10 px-1.5 py-0.5 font-mono text-[11px] font-bold text-emerald-400 ring-1 ring-emerald-500/20">GET</span>
                                ...
                                <div class="flex items-center gap-3 px-5 py-2.5">
                                    <span
                                        class="inline-flex w-12 shrink-0 justify-center rounded bg-emerald-500/10 px-1.5 py-0.5 font-mono text-[11px] font-bold text-emerald-400 ring-1 ring-emerald-500/20">GET</span>
                                    <code
                                        class="font-mono text-sm text-gray-200">/mod/{id}/versions</code>
                                ...
                                <div class="flex items-center gap-3 px-5 py-2.5">
                                    <span
                                        class="inline-flex w-12 shrink-0 justify-center rounded bg-emerald-500/10 px-1.5 py-0.5 font-mono text-[11px] font-bold text-emerald-400 ring-1 ring-emerald-500/20">GET</span>
                                    <code
                                        class="font-mono text-sm text-gray-200">/mods/dependencies</code>
                            ...
                            <div class="divide-y divide-white/5">
                                ...
                                <div class="flex items-center gap-3 px-5 py-2.5">
                                    <span
                                        class="inline-flex w-12 shrink-0 justify-center rounded bg-emerald-500/10 px-1.5 py-0.5 font-mono text-[11px] font-bold text-emerald-400 ring-1 ring-emerald-500/20">GET</span>
                                    <code
                                        class="font-mono text-sm text-gray-200">/addon/{id}/versions</code>
                                    <span class="ml-auto truncate pl-3 text-xs text-gray-400">Version
                                        history</span>
                                </div>
                                <div class="flex items-center gap-3 px-5 py-2.5">
                                    <span
                                        class="inline-flex w-12 shrink-0 justify-center rounded bg-emerald-500/10 px-1.5 py-0.5 font-mono text-[11px] font-bold text-emerald-400 ring-1 ring-emerald-500/20">GET</span>
                                    <code
                                        class="font-mono text-sm text-gray-200">/addons/dependencies</code>
                                    <span class="ml-auto truncate pl-3 text-xs text-gray-400">Resolve
                                        dependencies</span>
                                </div>
                            </div>
                            ...
                            <div class="divide-y divide-white/5">
                                <div class="flex items-center gap-3 px-5 py-2.5">
                                    <span
                                        class="inline-flex w-12 shrink-0 justify-center rounded bg-emerald-500/10 px-1.5 py-0.5 font-mono text-[11px] font-bold text-emerald-400 ring-1 ring-emerald-500/20">GET</span>
                                    <code
                                        class="font-mono text-sm text-gray-200">/mod-categories</code>
                                    <span class="ml-auto truncate pl-3 text-xs text-gray-400">List
                                        categories</span>
                                </div>
                                <div class="flex items-center gap-3 px-5 py-2.5">
                                    <span
                                        class="inline-flex w-12 shrink-0 justify-center rounded bg-emerald-500/10 px-1.5 py-0.5 font-mono text-[11px] font-bold text-emerald-400 ring-1 ring-emerald-500/20">GET</span>
                                    <code
                                        class="font-mono text-sm text-gray-200">/mod-categories/{identifier}</code>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:items-stretch mb-12">
                    ...
                    <div class="relative h-full overflow-hidden rounded-2xl">
                        ...
                        <div
                            class="relative z-10 h-full bg-yellow-950/50 ring-1 ring-yellow-800/60 rounded-2xl p-6">
                            <h3 class="font-semibold text-lg text-yellow-100 mb-4">A note on
                                stability</h3>
                            <p class="text-yellow-200 text-sm leading-6">
                                The API is versioned and currently sits at <code
                                    class="bg-yellow-900 px-1 py-0.5 rounded text-xs">v0</code>. It is
                    ...
                    <div class="relative h-full overflow-hidden rounded-2xl">
                        ...
                        <div
                            class="relative z-10 h-full bg-blue-950/50 ring-1 ring-blue-800/60 rounded-2xl p-6">
                            <h3 class="font-semibold text-lg text-blue-100 mb-4">Be a good citizen</h3>
                            <ul class="space-y-3 text-sm">
                                ...
                                <li class="flex items-start">
                                    ...
                                    <span class="text-blue-200">Send a descriptive <code
                                            class="bg-blue-900 px-1 py-0.5 rounded text-xs">User-Agent</code>
                ...
                {{-- Ready to build --}}
                <div
                    class="rounded-2xl ring-1 ring-white/10 bg-gradient-to-br from-gray-900 to-gray-950 p-8 text-center">
                    <h2 class="text-2xl font-bold text-gray-100 mb-2">Ready to build?</h2>
                    ...
                    <div class="flex flex-wrap justify-center gap-4">
                        ...
                        <a
                            ...
                            target="_blank"
                            class="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-lg bg-gray-800 px-6 py-3 text-base font-semibold text-gray-100 shadow-lg border border-gray-700 hover:bg-gray-700 transition-all duration-300"
                        >
