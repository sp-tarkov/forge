    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div
            ...
            <div class="px-4 py-8 sm:px-6 lg:px-8">
                ...
                {{-- Hero Section --}}
                <div
                    class="relative overflow-hidden bg-gradient-to-br from-gray-100 via-white to-gray-50 dark:from-gray-900 dark:via-black dark:to-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl shadow-2xl mb-12">
                    ...
                    <div class="relative px-6 py-10 sm:px-8 sm:py-12">
                        <div class="mx-auto max-w-4xl text-center">
                            <div class="mb-6 flex justify-center">
                                <div
                                    class="relative flex h-24 w-24 items-center justify-center rounded-lg bg-gradient-to-br from-gray-200 via-gray-300 to-gray-400 dark:from-gray-800 dark:via-gray-900 dark:to-black shadow-2xl overflow-hidden border border-gray-300 dark:border-gray-700">
                                    {{-- Light/Dark gritty texture overlays --}}
                                    <div
                                    ...
                                    <flux:icon
                                        name="cloud-arrow-down"
                                        class="relative z-10 size-12 text-gray-700 dark:text-gray-200 drop-shadow-2xl"
                                    />
                                </div>
                            </div>

                            <h1
                                class="text-3xl font-bold tracking-tight text-gray-800 dark:text-gray-100 sm:text-4xl mb-4">
                                SPT Installer
                            </h1>
                ...
                <div class="mb-8 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:items-stretch">
                    ...
                    <div class="relative h-full overflow-hidden">
                        ...
                        <div
                            class="relative z-10 h-full bg-blue-50 dark:bg-blue-950/50 border border-blue-200 dark:border-blue-800 rounded-xl p-6">
                            <h3 class="font-semibold text-lg text-blue-900 dark:text-blue-100 mb-4">The Installer Will:
                            </h3>
                            <ul class="space-y-3">
                                <li class="flex items-start">
                                    ...
                                    />
                                    <span class="text-blue-800 dark:text-blue-200">Check you have the correct version of
                                        .NET installed</span>
                                </li>
                                <li class="flex items-start">
                                    <flux:icon
                                        ...
                                        class="size-4 mt-1 mr-3 text-blue-600 flex-shrink-0"
                                    />
                                    <span class="text-blue-800 dark:text-blue-200">Duplicate your EFT installation to a
                                ...
                                <li class="flex items-start">
                                    <flux:icon
                                        ...
                                        class="size-4 mt-1 mr-3 text-blue-600 flex-shrink-0"
                                    />
                                    <span class="text-blue-800 dark:text-blue-200">Patch the duplicated EFT files to the
                                ...
                                <li class="flex items-start">
                                    <flux:icon
                                        ...
                                        class="size-4 mt-1 mr-3 text-blue-600 flex-shrink-0"
                                    />
                                    <span class="text-blue-800 dark:text-blue-200">Download the most recent version of
                    ...
                    <div class="relative h-full overflow-hidden">
                        ...
                        <div
                            class="relative z-10 h-full bg-yellow-50 dark:bg-yellow-950/50 border border-yellow-200 dark:border-yellow-800 rounded-xl p-6">
                            <h3 class="font-semibold text-lg text-yellow-900 dark:text-yellow-100 mb-4">Things to Note
                            </h3>
                            <ul class="space-y-3">
                                <li class="flex items-start">
                                    <flux:icon
                                    ...
                                    />
                                    <span class="text-yellow-800 dark:text-yellow-200">Make sure you have a legitimate
                                ...
                                <li class="flex items-start">
                                    <flux:icon
                                        ...
                                        class="size-4 mt-1 mr-3 text-yellow-600 flex-shrink-0"
                                    />
                                    <span class="text-yellow-800 dark:text-yellow-200">Do not place this installer on
                                ...
                                <li class="flex items-start">
                                    <flux:icon
                                        ...
                                        class="size-4 mt-1 mr-3 text-yellow-600 flex-shrink-0"
                                    />
                                    <span class="text-yellow-800 dark:text-yellow-200">The installer downloads SPT and
                                        patcher files to: <br /><code
                                            class="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded text-xs whitespace-nowrap"
                ...
                <div class="mb-8 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:items-stretch">
                    ...
                    <div class="relative h-full overflow-hidden">
                        {{-- Background Icon --}}
                        <div
                            class="absolute -top-8 -right-8 text-green-600/15 dark:text-green-400/10 select-none pointer-events-none z-0">
                            <flux:icon
                                name="book-open"
                                class="size-48"
                            />
                        ...
                        <div
                            class="relative z-10 h-full bg-green-50 dark:bg-green-950/50 border border-green-200 dark:border-green-800 rounded-xl p-6">
                            <h3 class="font-semibold text-lg text-green-900 dark:text-green-100 mb-4">Step-by-Step
                                Usage Guide</h3>
                            <ol class="space-y-3">
                                <li class="flex items-start">
                                    <span
                                        class="flex-shrink-0 w-6 h-6 bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 rounded-full flex items-center justify-center text-sm font-medium mr-3 mt-0.5"
                                    >1</span>
                                ...
                                <li class="flex items-start">
                                    <span
                                        class="flex-shrink-0 w-6 h-6 bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 rounded-full flex items-center justify-center text-sm font-medium mr-3 mt-0.5"
                                    >2</span>
                                    <span class="text-green-800 dark:text-green-200">Place in a new folder. We
                                        recommend: <br /><code
                                            class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-sm whitespace-nowrap"
                                ...
                                <li class="flex items-start">
                                    <span
                                        class="flex-shrink-0 w-6 h-6 bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 rounded-full flex items-center justify-center text-sm font-medium mr-3 mt-0.5"
                                    >3</span>
                                    <span class="text-green-800 dark:text-green-200">Ensure your EFT install is updated
                                ...
                                <li class="flex items-start">
                                    <span
                                        class="flex-shrink-0 w-6 h-6 bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 rounded-full flex items-center justify-center text-sm font-medium mr-3 mt-0.5"
                                    >5</span>
                                    <span class="text-green-800 dark:text-green-200">Wait for it to say it has
                                        completed</span>
                                </li>
                                <li class="flex items-start">
                                    <span
                                        class="flex-shrink-0 w-6 h-6 bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 rounded-full flex items-center justify-center text-sm font-medium mr-3 mt-0.5"
                                    >6</span>
                                    <span class="text-green-800 dark:text-green-200">Close the installer. You are ready
                                        to play!</span>
                                </li>
                            </ol>
                        </div>
                    ...
                    <div class="relative h-full overflow-hidden">
                        {{-- Background Icon --}}
                        <div
                            class="absolute -top-8 -right-8 text-cyan-600/15 dark:text-cyan-400/10 select-none pointer-events-none z-0">
                            <flux:icon
                                name="play"
                                class="size-48"
                            />
                        ...
                        <div
                            class="relative z-10 h-full bg-cyan-50 dark:bg-cyan-950/50 border border-cyan-200 dark:border-cyan-800 rounded-xl p-6">
                            <h3 class="font-semibold text-lg text-cyan-900 dark:text-cyan-100 mb-4">How to Run SPT
                                After Installation</h3>
                            <ol class="space-y-3">
                                <li class="flex items-start">
                                    <span
                                        class="flex-shrink-0 w-6 h-6 bg-cyan-100 dark:bg-cyan-900 text-cyan-800 dark:text-cyan-200 rounded-full flex items-center justify-center text-sm font-medium mr-3 mt-0.5"
                                    >1</span>
                                    <span class="text-cyan-800 dark:text-cyan-200">Start the <code
                ...
                <div
                    ...
                    class="text-center"
                >
                    <h3 class="font-semibold text-lg mb-2 text-gray-800 dark:text-gray-200">Video Installation Guide
                    </h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-6">Created by McDewgle</p>
                    <div class="max-w-4xl mx-auto">
                        <div
                            class="relative overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 rounded-xl shadow-2xl p-2">
