...
>
    @if ($list->isFavourites())
        <div class="w-28 shrink-0 self-stretch bg-gradient-to-br from-rose-950/40 to-rose-900/20 flex items-center justify-center">
    ...
    @else
        <div class="relative w-28 shrink-0 self-stretch overflow-hidden">
            <div class="absolute inset-0 bg-[repeating-linear-gradient(45deg,#020509,#020509_4px,#030712_4px,#030712_8px)] transition-opacity duration-200 group-hover:opacity-0"></div>
            <div class="absolute inset-0 bg-[repeating-linear-gradient(45deg,#000000,#000000_4px,#010203_4px,#010203_8px)] opacity-0 transition-opacity duration-200 group-hover:opacity-100"></div>
    ...
    <div class="flex flex-col flex-1 min-w-0 p-3 sm:p-4">
        ...
        <div class="mt-auto pt-2 flex items-center gap-2 text-xs text-gray-400">
