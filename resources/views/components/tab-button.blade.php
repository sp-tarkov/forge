<button
    ...
    class="tab group relative min-w-0 flex-1 overflow-hidden py-4 px-4 text-center text-sm text-white bg-cyan-700 hover:bg-cyan-600 focus:z-10 last:rounded-r-xl first:rounded-l-xl flex items-center justify-center gap-1"
    {{ $attributes }}
>
    {{ __($displayLabel) }}
    <svg
