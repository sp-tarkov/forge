<div>
    <div class="absolute top-1.5 right-1.5">
        <div
            x-data="{ moderationMenu: false, moderationMenuKeyboard: false }"
            x-on:keydown.esc.window="moderationMenu = false, moderationMenuKeyboard = false"
            class="relative"
        >
            <button
                type="button"
                x-on:click="moderationMenu = ! moderationMenu"
                x-on:keydown.space.prevent="moderationMenuKeyboard = true"
                x-on:keydown.enter.prevent="moderationMenuKeyboard = true"
                x-on:keydown.down.prevent="moderationMenuKeyboard = true"
            ...
            <div
                ...
                x-on:click.outside="moderationMenu = false, moderationMenuKeyboard = false"
