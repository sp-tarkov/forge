<div
    class="flex align-top{{ !$canReportItem && !$showReportModal ? ' hidden' : '' }}{{ $variant === 'link' ? ' border-t border-gray-800 py-4 mt-4' : '' }}">
    @if ($canReportItem)
        @switch($variant)
            @case('link')
                <button
    ...
    >
        @if (!$submitted)
            ...
            <div class="space-y-0">
                ...
                <div class="space-y-6">
                    <div
                        class="bg-blue-900/20 border border-blue-800 rounded-lg p-4">
                        <div class="flex items-start gap-3">
                            ...
                            />
                            <div>
                                <flux:text class="text-blue-200 text-sm font-medium">
                                    {{ __('Report Guidelines') }}
                                </flux:text>
                                <flux:text class="text-blue-300 text-sm mt-1">
            ...
            <div class="space-y-0">
                ...
                <div class="border-b border-gray-700 pb-6 mb-6">
                    <div class="flex items-center justify-center">
                        <div
                            class="flex h-12 w-12 items-center justify-center rounded-full bg-green-900/30">
                            <flux:icon
                                name="check"
