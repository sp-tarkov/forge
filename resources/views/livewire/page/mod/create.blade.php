                    ...
                    <div class="px-4 py-5 bg-white dark:bg-gray-900 sm:p-6 shadow-sm sm:rounded-tl-md sm:rounded-tr-md">
                        <div class="grid grid-cols-6 gap-8">
                            ...
                            <flux:field class="col-span-6" x-data="{ count: 0, text: '' }">
                                ...
                                <flux:description>{{ __('A unique identifier for your mod in reverse domain notation. This GUID should match the one in your mod files and will be used to identify your mod across different systems. Use only lowercase letters, numbers, and dots. Required for mod versions compatible with SPT 4.0.0 and above.') }}</flux:description>
