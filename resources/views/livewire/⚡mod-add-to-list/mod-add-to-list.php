...
new class extends Component
{
    ...
    /**
     * Complete the deferred add with only the primary mod, discarding the
     * suggested dependencies.
     */
    public function addModOnly(ModListService $service): void
    {
        $this->selectedDependencyIds = [];

        $this->confirmDependencies($service);
    }
