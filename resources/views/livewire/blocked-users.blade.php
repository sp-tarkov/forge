                ...
                @foreach($blockedUsers as $block)
                    <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700">
                        <div class="flex items-center space-x-4">
                            <img class="h-12 w-12 rounded-full" src="{{ $block->blocked->profile_photo_url }}" alt="{{ $block->blocked->name }}">
                            <div>
                        ...
                        <div>
                            <flux:button
                                ...
                                <div class="flex items-center">
                                    <flux:icon.x-mark variant="micro" class="mr-1.5" wire:loading.remove />
                                    <flux:icon.arrow-path variant="micro" class="mr-1.5 animate-spin" wire:loading />
                                    {{ __('Unblock') }}
                                </div>
                            </flux:button>
                        </div>
