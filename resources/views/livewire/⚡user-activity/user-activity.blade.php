<div class="space-y-6">
    ...
    @if ($this->recentActivity->isEmpty())
        <div class="text-center py-12">
            <div class="flex justify-center mb-4">
                <flux:icon.clock class="w-12 h-12 text-gray-500" />
            </div>
            <flux:text
                variant="muted"
                class="text-lg"
    ...
    @else
        <div class="relative">
            {{-- Timeline line --}}
            <div class="absolute left-16 top-0 bottom-0 w-px bg-gray-700 -z-10"></div>
                    ...
                    <div class="relative flex items-center space-x-8">
                        ...
                        <div class="flex-1 min-w-0">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    @if ($this->isEventPrivate($event))
                                        <flux:tooltip content="This activity is private and only visible to you.">
                                            <flux:icon.lock-closed class="w-4 h-4 text-gray-500" />
                                        </flux:tooltip>
                                    @endif
                                </div>
                                <time
                            ...
                            @if ($this->hasContext($event))
                                <div class="bg-gray-800/50 rounded-lg px-3 py-2 mb-1.5 mt-1">
                            ...
                            {{-- Additional metadata --}}
                            <div
                                class="mt-0.5 flex items-center flex-wrap gap-x-4 gap-y-1 text-xs text-gray-400">
